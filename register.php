            ...
            <div class="shadow-xl p-4 p-lg-5 bg-white">
                ...
                <form method="POST">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="register-fname" name="f_name" placeholder="Enter your first name">
                    </div>
                    <div class="form-group">
                      <label class="form-label" for="register-lname">Last name</label>
                      <input type="text" class="form-control" id="register-lname" name="l_name" placeholder="Enter your last name">
                    </div>
                    <div class="form-group">
                    ...
                    <button type="button" onclick="user_register()" class="btn btn-dark d-block w-100 my-4">Sign Up</button>
                  </form>
