        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center flex-column flex-lg-row">
                ...
                <div class="d-flex align-items-center justify-content-end flex-column flex-lg-row">
                    <p class="small m-0 text-center text-lg-start">&copy; <?php echo date('Y'); ?> OldSkool All Rights Reserved. Template by <a
                            href="https://www.joymojumder.com">JOY</a></p>
    ...
    <!-- Theme JS -->
    <!-- Vendor JS -->
    <script src="<?php echo SITE_PATH ?>assets/js/vendor.bundle.js"></script>
    
    <!-- Theme JS -->
    <script src="<?php echo SITE_PATH ?>assets/js/theme.bundle.js"></script>
